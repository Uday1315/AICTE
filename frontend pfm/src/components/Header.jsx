...
function Header()
{
  ...
  const handleShowLogin = () =>{
    ...
    return (
        <>
            <div style={{borderRadius:'5px', backgroundColor:'white',height:'70px',display:'flex',justifyContent:'space-between', marginTop:'-90px', color:'black', width: '117.4%',marginLeft:'-90px'}}>
